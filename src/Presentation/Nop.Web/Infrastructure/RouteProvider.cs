    ...
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapLocalizedRoute("AddProductToCart-Details",
                            ...
                            new[] { "Nop.Web.Controllers" });
            //buy now simple functionality (add product if doesn't already exist).
            routes.MapLocalizedRoute("BuyNowSimpleFunctionality",
                            "BuyNowSimpleFunctionality/{productId}/{shoppingCartTypeId}",
                            new { controller = "ShoppingCart", action = "BuyNowSimpleFunctionality" },
                            new { productId = @"\d+", shoppingCartTypeId = @"\d+" },
                            new[] { "Nop.Web.Controllers" });
            //product tags
