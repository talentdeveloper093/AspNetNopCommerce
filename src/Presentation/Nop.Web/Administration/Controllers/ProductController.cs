    ...
    public partial class ProductController : BaseAdminController
    {
        ...
        protected virtual void UpdateLocales(Product product, ProductModel model)
        {
            foreach (var localized in model.Locales)
            {
                ...
                _localizedEntityService.SaveLocalizedValue(product,
                                                               ...
                                                               localized.LanguageId);
                _localizedEntityService.SaveLocalizedValue(product,
                                                               x => x.ShippingandPaymentPolicies,
                                                               localized.ShippingandPaymentPolicies,
                                                               localized.LanguageId)                                                                                                                             ;
                _localizedEntityService.SaveLocalizedValue(product,
                                                               x => x.MetaKeywords,
                ...
                if (attribute.ShouldHaveValues())
                {
                    ...
                    foreach (var attributeValue in attributeValues)
                    {
                        var attributeValueModel = new AddProductAttributeCombinationModel.ProductAttributeValueModel
                        {
                            ...
                            IsMakeOffer = attributeValue.IsMakeOffer
                        };
        ...
        public virtual ActionResult ProductList(DataSourceRequest command, ProductListModel model)
        {
            ...
            gridModel.Data = products.Select(x =>
            {
               ...
               // var productModel = x.ToModel();
                //little performance optimization: ensure that "FullDescription" is not returned
                productModel.ShippingandPaymentPolicies = "";
        ...
        public virtual ActionResult Edit(int id)
        {
            ...
            AddLocales(_languageService, model.Locales, (locale, languageId) =>
            {
                ...
                locale.ShippingandPaymentPolicies = product.GetLocalized(x => x.ShippingandPaymentPolicies, languageId, false, false);
        ...
        public virtual ActionResult ProductAttributeMappingInsert(ProductModel.ProductAttributeMappingModel model)
        {
            ...
            foreach (var predefinedValue in predefinedValues)
            {
                var pav = new ProductAttributeValue
                {
                    ...
                    IsMakeOffer = predefinedValue.IsMakeOffer
                };
        ...
        public virtual ActionResult ProductAttributeValueEditPopup(string btnId, string formId, ProductModel.ProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                pav.IsMakeOffer = model.IsMakeOffer;
