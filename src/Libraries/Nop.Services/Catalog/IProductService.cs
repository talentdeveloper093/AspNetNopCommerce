...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IPagedList<Product> GetOffers(string ProductName, string ProductStatus, int pageIndex = 0, int pageSize = int.MaxValue);

        List<Product> GetAllOffers();

      //  IPagedList<Product> OfferSalesList(int pageIndex = 0, int pageSize = int.MaxValue);

        IQueryable<Product> CounteredOffersList(int CustomerId);
