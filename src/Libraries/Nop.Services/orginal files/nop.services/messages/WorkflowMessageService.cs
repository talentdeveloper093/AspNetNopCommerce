...
namespace Nop.Services.Messages
{
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        public virtual int SendNewOfferNotification(Customer customer, Product product, int languageId, string CustomerMessage, int OfferedPrice)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.SendNewOfferNotification, store.Id);
            if (messageTemplate == null)
                return 0;
            ...
            _messageTokenProvider.AddCustomerTokens(tokens, customer);
            _messageTokenProvider.AddProductTokens(tokens, product, languageId);
            tokens.Add(new Token("Customer.Message", CustomerMessage, true));
            tokens.Add(new Token("Customer.Price", OfferedPrice, true));
            //event notification
            _eventPublisher.MessageTokensAdded(messageTemplate, tokens);
        ...
        public virtual int OfferStatusNotification(Customer customer, Product product, int languageId, int OfferedPrice, string OfferStatus)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
            ...
            var messageTemplate = GetActiveMessageTemplate(MessageTemplateSystemNames.OfferStatusNotification, store.Id);
            if (messageTemplate == null)
                return 0;
            ...
            _messageTokenProvider.AddCustomerTokens(tokens, customer);
            _messageTokenProvider.AddProductTokens(tokens, product, languageId);
            tokens.Add(new Token("Offer.Status", OfferStatus, true));
            tokens.Add(new Token("Offer.Price", OfferedPrice, true));
            //event notification
            _eventPublisher.MessageTokensAdded(messageTemplate, tokens);
