...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        int SendNewOfferNotification(Customer customer, Product product, int languageId
           , string MessageToSeller, int OfferedPrice);

        int OfferStatusNotification(Customer customer, Product product, int languageId, int OfferedPrice
         , string OfferStatus);
    }
}
